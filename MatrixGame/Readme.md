...
The game is displayed on on a 8x8 matrix using a MAX7219 driver.<br/>
For the controls it is used a joystick.<br/>
While you are playing the game you can see on the LCD screen the number of lives, the level that you selected to play, score and how much time is left.<br/>
You can control the LCD's contrast with the help of a potentiometer.<br/>
